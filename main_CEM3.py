...
from model_CEM3 import lowlight_enhance
from utils import *
...
parser.add_argument('--save_dir', dest='save_dir', default='./test_results/UAV/resize/3.13/', help='directory for testing outputs')
parser.add_argument('--test_dir', dest='test_dir', default='./test_data/UAV/resize/3.14', help='directory for testing inputs')
...
def lowlight_test(lowlight_enhance):
    ...
    #test_mos_data_names = glob('./our485/high/*.png') 
    test_low_data = []
    #test_high_data = []
